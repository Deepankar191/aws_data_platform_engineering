#!/usr/bin/env python3
"""
Build design_explanation.pdf from design_explanation.md — Part 3 deliverable
(IFRS 9 ECL provisioning — 1-page design explanation), rendered with the same reportlab
...
MD_PATH = os.path.join(HERE, "design_explanation.md")
PDF_PATH = os.path.join(HERE, "design_explanation.pdf")
FOOTER = "Credit Decision Data Platform — Part 3: IFRS 9 ECL Provisioning"
